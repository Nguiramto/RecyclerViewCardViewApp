package com.example.recyclerviewcardviewapp; // App package (must match your project structure)
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.CategoryViewHolder> {
    ...
    private List<Category> categoryList; // Data source (list of categories)
    ...
    public void onBindViewHolder(@NonNull CategoryViewHolder holder, int position) {
        ...
        Category category = categoryList.get(position); // Get current category
        ...
        CardAdapter cardAdapter = new CardAdapter(category.getItems());
